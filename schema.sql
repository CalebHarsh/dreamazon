...
SELECT departments.department_id, departments.department_name , departments.over_head_costs, SUM(products.products_sales) AS "product sales", SUM(products.products_sales) - departments.over_head_costs AS "Total Sales"
